    ...
    >
      <Card
        className={cn(
          ...
          "bg-card backdrop-blur-3xl border border-border/30 shadow-none",
          "py-1 gap-0",
      ...
      >
        <div
          ...
          className={cn(
            ...
            "border-b border-border/40 backdrop-blur-3xl",
            isActive ? "bg-card/85 backdrop-brightness-80" : "bg-card/85 backdrop-brightness-90",
